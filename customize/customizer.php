...
function juliet_customizer_fields( $fields ) {
    ...
    $fields[] = array(
        ...
        'active_callback'  => array( array( 'setting'  => 'juliet_image_logo_show', 'operator' => '==', 'value'    => '0' ) ),
    ...
    $fields[] = array(
        ...
        'active_callback'  => array( array( 'setting'  => 'juliet_blog_feed_meta_show', 'operator' => '==', 'value'    => '1', ),)
    );
    $fields[] = array(
        'type'        => 'toggle',
    ...
    $fields[] = array(
        ...
        'active_callback'  => array( array( 'setting'  => 'juliet_posts_meta_show', 'operator' => '==', 'value'    => '1', ), )
    );
    $fields[] = array(
        'type'        => 'toggle',
